          ...
          >
            ...
            {(salary_description || salary_type?.label) && (
              <>
                ...
                {salary_type?.label && <p>Lönetyp: {salary_type.label}</p>}
              </>
            )}{" "}

            <h3>Var ligger arbetsplatsen?</h3>
            <p>{workplace_address.street_address}<br />
            ...
            {application_contacts && application_contacts.length > 0 && (
            <>
            <h2>Kontakt</h2>
              <p>{application_contacts[0].name}<br />
              <a href={`mailto:${application_contacts[0].email}`}>{application_contacts[0].email}</a>
              <br />
              {application_contacts[0].telephone}</p>
            </>
            )}            
            <DigiInfoCard
